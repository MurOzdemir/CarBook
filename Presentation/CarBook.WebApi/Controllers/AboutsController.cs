...
using CarBook.Application.Features.CQRS.Handles.AboutHandlers;
...
namespace CarBook.WebApi.Controllers
{
    ...
    public class AboutsController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAbout(UpdateAboutCammand cammand)
        {
            await _updateAboutCommandHandler.Handle(cammand);
